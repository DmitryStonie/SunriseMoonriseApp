...
import com.example.sunrisemoonriseapp.data.retrofit.geocoder.GeocoderRemoteData
import com.example.sunrisemoonriseapp.data.retrofit.geocoder.GeocoderService
...
object RetrofitGeocoderModule {
    ...
    @Singleton
    @Named("geocoder")
    fun provideGeocoderRetrofit(@Named("geocoderApiUrl") baseUrl : String): Retrofit = Retrofit.Builder()
