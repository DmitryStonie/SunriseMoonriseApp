...
class SunRepository @Inject constructor(
    ...
    private suspend fun getDayRemote(dateForSun: String, latitude: String, longitude: String): Day? {
        ...
        suspend fun getDay(date: String, dateForSun: String, latitude: String, longitude: String): Day? {
